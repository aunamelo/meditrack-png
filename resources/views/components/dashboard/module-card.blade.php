   ...
   @class([
    ...
    <div class="flex items-start gap-4">
        <div @class([
            ...
            'bg-health-50 text-health-700 dark:bg-health-900/40 dark:text-health-300' => ! $primary,
        ])>
        ...
        <div class="min-w-0 flex-1">
            ...
            <span @class(['mt-1 block text-sm', 'text-white/90' => $primary, 'text-muted' => ! $primary])>{{ $description }}</span>
        </div>
    </div>
    <span @class(['mt-5 inline-flex items-center text-xs font-bold uppercase tracking-wider', 'text-white/90' => $primary, 'text-health-700 dark:text-health-300' => ! $primary])>
        Open

...
@php
    $classes = match ($variant) {
        ...
        'expiring_soon', 'partial', 'pending', 'customs' => 'bg-amber-100 text-amber-800 dark:bg-amber-950/50 dark:text-amber-300',
        ...
        'ordered', 'manufacturing', 'sent', 'shipped' => 'bg-blue-100 text-blue-800 dark:bg-blue-950/50 dark:text-blue-300',
        'fx_cleared' => 'bg-emerald-100 text-emerald-800 dark:bg-emerald-950/50 dark:text-emerald-300',

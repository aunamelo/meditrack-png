<section class="space-y-6">
    <header class="border-b border-line pb-4 dark:border-zinc-800">
        <h2 class="heading-section text-rose-700 dark:text-rose-300">Delete account</h2>
        <p class="mt-1 text-sm text-muted">
            Permanently remove your portal account. This cannot be undone — contact your administrator if you need access restored.
        </p>
    </header>
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <p class="mt-2 text-sm text-muted">
                {{ __('Enter your password to confirm permanent deletion of your account and profile data.') }}
            </p>

...
class PortalNavigationService
{
    ...
    protected static function adminNav($user, ?array $meta): array
    {
        return array_values(array_filter([
            ...
            canManageUsers()
                ...
                : null,
            self::item('Administration', 'Audit Logs', 'View system activity logs', route('admin.dashboard.audit-logs.index'), request()->routeIs('*.dashboard.audit-logs.*'), 'clipboard-list'),
    ...
    protected static function pharmacyManagerNav($user, ?array $meta): array
    {
        return array_values(array_filter([
            ...
            self::item('Supply', 'Live Delivery Map', 'Real-time GPS for vehicles on the road', getDashboardLiveMapRoute('index'), request()->routeIs('*.dashboard.live-map.*'), 'truck'),
            ...
            self::item('Ward Inventory', 'Wards', 'Manage hospital wards', getDashboardWardRoute('index'), request()->routeIs('*.dashboard.wards.*'), 'building-hospital'),
            self::item('Ward Inventory', 'Drug Issuances', 'Issue drugs to wards', getDashboardDrugIssuanceRoute('index'), request()->routeIs('*.dashboard.drug-issuances.*'), 'arrow-right-circle'),
            self::item('Ward Inventory', 'Drug Returns', 'Return drugs from wards', getDashboardDrugReturnRoute('index'), request()->routeIs('*.dashboard.drug-returns.*'), 'arrow-left-circle'),
            self::item('Ward Inventory', 'Drug Usage Log', 'Track ward consumption', getDashboardDrugUsageRoute('index'), request()->routeIs('*.dashboard.drug-usages.*'), 'clipboard-list'),
            self::item('Ward Inventory', 'Ward Stock', 'Monitor ward inventory', getDashboardWardStockRoute('index'), request()->routeIs('*.dashboard.ward-stocks.*'), 'warehouse'),
